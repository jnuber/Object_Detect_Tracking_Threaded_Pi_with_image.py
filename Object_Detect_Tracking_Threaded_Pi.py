# USAGE
# python Object_Detect_Tracking_Treaded_Pi.py - Optimized
# by John Nuber
# Jan 2017
#
# Credits  
...
########################################################################
# pi version added
# *** NOTE: The PiVideoStream was modified to purposely set the cameraq
...
image  = cv2.imread("/home/pi/images/calibration_image_Pi.jpg")

gray    = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
blurred = cv2.GaussianBlur(gray, (9, 9), 0)
edged   = auto_canny(gray)

# The following was used foqr troubleshooting
...
cv2.moveWindow( "Target", 800,100)      # Position window on user display at x,y cooridnates
